...
<tr>
	...
	<td>
		...
		<p class="description"><?php esc_html_e( 'Replace links in the CiviCRM Admin Utilities Shortcuts Menu with ones more useful for developers.', 'haystack-civicrm-utilities' ); ?></p>
	</td>
</tr>
