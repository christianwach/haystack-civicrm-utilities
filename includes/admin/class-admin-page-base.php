...
abstract class Page_Base {
	...
	protected function admin_help_get() {
		...
		if ( ! file_exists( $template ) ) {
			$template = HAYSTACK_CU_PATH . $this->path_template . $this->path_help . 'page-settings-help.php';
		}
	...
	public function page_render() {
		...
		if ( ! file_exists( $template ) ) {
			$template = HAYSTACK_CU_PATH . $this->path_template . $this->path_page . $template_name;
		}
	...
	public function meta_box_submit_render( $unused, $metabox ) {
		...
		if ( ! file_exists( $template ) ) {
			$template = HAYSTACK_CU_PATH . $this->path_template . $this->path_metabox . 'metabox-settings-submit.php';
		}
